...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Tenim 473 individus en total, dels quals se'n van eliminar 60, per tant ens quedem amb 413. D'aquest total, 218 estan en un estadi temprà i 165 es troben en un estadi avançat. A més dels individus, tenim la informarció de 58037 gens.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Fent aquesta funció veiem que ens hem quedat amb 10 gens.
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: Hi ha molts gens diferentment expressats que es relacionen amb bastants processos diferents. N'hi ha uns quants que es relacionen amb el desenvolupament de l'epiteli i l'epidermis i també amb el desenvolupament de la pell i òrgans en general. Per tant, podem veure que sí que tenen funcions que podem relacionar amb el càncer de pell.
...
Practical based on Juan RamÃ³n GonzÃ¡lez' material available at [GitHub](https://github.com/isglobal-brge/TeachingMaterials/tree/master/Master_Bioinformatics).
